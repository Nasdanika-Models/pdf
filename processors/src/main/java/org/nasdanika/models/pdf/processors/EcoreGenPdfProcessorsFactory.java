package org.nasdanika.models.pdf.processors;
...
@EPackageNodeProcessorFactory(nsURI = PdfPackage.eNS_URI)
public class EcoreGenPdfProcessorsFactory {
...
//	public final AccessLevelProcessorsFactory accessLevelFactory;
	...
	public EcoreGenPdfProcessorsFactory(Context context) {
