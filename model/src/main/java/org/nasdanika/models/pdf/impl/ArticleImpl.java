 ...
 * </p>
 * <ul>
 *   <li>{@link org.nasdanika.models.pdf.impl.ArticleImpl#getParagraphs <em>Paragraphs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArticleImpl extends MinimalEObjectImpl.Container implements Article {
	...
	protected EClass eStaticClass() {
		return PdfPackage.Literals.ARTICLE;
	}
	...
	public EList<Paragraph> getParagraphs() {
		return (EList<Paragraph>)eDynamicGet(PdfPackage.ARTICLE__PARAGRAPHS, PdfPackage.Literals.ARTICLE__PARAGRAPHS, true, true);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PdfPackage.ARTICLE__PARAGRAPHS:
