...
public class PdfPackageImpl extends EPackageImpl implements PdfPackage {
	 ...
	 * @see org.nasdanika.models.pdf.PdfPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 */
	@Override
	public EAttribute getDocument_Created() {
	 ...
	 */
	@Override
	public EAttribute getDocument_Keywords() {
	 ...
	 */
	@Override
	public EAttribute getDocument_Producer() {
	 ...
	 */
	@Override
	public EReference getParagraph_Lines() {
	...
	public void createPackageContents() {
		...
		createEAttribute(documentEClass, DOCUMENT__CREATED);
		createEAttribute(documentEClass, DOCUMENT__CREATOR);
		createEAttribute(documentEClass, DOCUMENT__KEYWORDS);
		createEAttribute(documentEClass, DOCUMENT__MODIFIED);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getDocument_Created(), ecorePackage.getEDate(), "created", null, 0, 1, Document.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDocument_Creator(), ecorePackage.getEString(), "creator", null, 0, 1, Document.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDocument_Keywords(), ecorePackage.getEString(), "keywords", null, 0, 1, Document.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDocument_Modified(), ecorePackage.getEDate(), "modified", null, 0, 1, Document.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDocument_Producer(), ecorePackage.getEString(), "producer", null, 0, 1, Document.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
