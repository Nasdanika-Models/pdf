 ...
 * </p>
 * <ul>
 *   <li>{@link org.nasdanika.models.pdf.impl.ParagraphImpl#getLines <em>Lines</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParagraphImpl extends MinimalEObjectImpl.Container implements Paragraph {
	...
	protected EClass eStaticClass() {
		return PdfPackage.Literals.PARAGRAPH;
	}
	...
	public EList<Line> getLines() {
		return (EList<Line>)eDynamicGet(PdfPackage.PARAGRAPH__LINES, PdfPackage.Literals.PARAGRAPH__LINES, true, true);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PdfPackage.PARAGRAPH__LINES:
